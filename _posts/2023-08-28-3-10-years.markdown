...
First, I did not work exactly what I thought I would, and therefore my Ph.D. ended up being quite different than what I thought my Ph.D would be.  I started in CRDTs, I left that area and moved to program analysis and testing.  This made sense for me, but only in retrospect: I had done testing for years before moving to Basho, and did distributed systems testing at Basho.  It was a thing I was good at, and as my initial blog post shows, it was where this entire blog started before I even started my Ph.D.  So, it makes sense, but it _was not the thing I signed up to do and wasn't what I set out to do._  This wasn't a big thing for me --- I feel like I discovered my true calling --- but, it's something that happend.
