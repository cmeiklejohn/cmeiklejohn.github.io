...
Here's the thing: most universities don't even have a software engineering program. They have computer science programs. And computer science is a discipline designed to produce researchers. Algorithms, data structures, theory of computation, concurrent programming. It's a rigorous education in the *how* of computing. The craft of writing code. But it was co-opted decades ago as the default training path for people who are going to spend their careers doing software engineering, which is a fundamentally different discipline.

Software engineering is about the *what*. What do you build? How do you design it so it's safe to operate? How do you release it reliably? How do you reason about failure? Courses like 17-313 teach these things, and they teach them well. But very few universities have a dedicated SE program. Most students get one or two SE courses inside a CS degree and call it done.

That distinction used to matter less when every engineer was also the person writing the code. Now that AI is taking over more of the *how*, the *what* is all that's left. And we don't have enough curriculum around it. Platform engineering can't be an afterthought or a single lecture in a survey course. It needs to be a first-class part of how we teach students to think about building software.
