...
I want to be clear: the SE curriculum isn't fundamentally wrong. Courses like 17-313 teach the right things. But software engineering as a discipline has been underserviced for a long time. Universities like CMU and MIT have historically emphasized the *how* of computing: algorithms, data structures, concurrent programming, systems programming. The craft of writing code. What's been underserved is the *what*: what do you build, how do you design it so it's safe to operate, how do you release it reliably, how do you reason about failure? That distinction used to matter less when every engineer was also the person writing the code. Now that AI is taking over more of the *how*, the *what* is all that's left. And we don't have enough curriculum around it. This is a sea change. Platform engineering can't be an afterthought or a single lecture in a survey course. It needs to be a first-class part of how we teach students to think about building software.
