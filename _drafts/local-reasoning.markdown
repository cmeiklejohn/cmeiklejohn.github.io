...
This isn't a complaint about the models. Every model in this story was smart enough, and the whole program fit inside a context window all summer. I think any of these sessions, handed the right question, would have found the gridlock long before a crowd did. The question nothing in the loop ever asked is what happens to this program when a crowd shows up. I asked that question professionally for years, about other people's systems, and it didn't occur to me to ask it about mine. Whether a loop built entirely out of local reasoning can be made to ask it on its own is the question I'm left with. I don't have the answer. Nobody has pointed a crowd at the Shows page, and until something wonders what would happen, the answer arrives the way it did at Red Rocks.
